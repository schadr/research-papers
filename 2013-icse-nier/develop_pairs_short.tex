...
% TODO rephrase to motivate an approach
...
%communication and even effect software quality~\cite{nagappan:icse:2008}. 
In our study we uncover the existence of pairs of
...
\label{sec:pattern}
%TODO rephrase to focus on approac
...
%A Fisher Exact Value test yields significance at a confidence level of $\alpha = .05$ with a p-value of $4.273\cdot10^{-5}$.
...
(\#failed). 
%The $p_x$ values are all above 0.74, implying that the likelihood
