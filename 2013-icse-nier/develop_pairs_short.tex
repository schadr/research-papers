...
is needed to avoid build failure, or which of these gaps are more important to
...
We choose to present the twenty that are most frequent that are statistically related to failed builds.

We rank the failure related \emph{technical} pairs (see Tables~\ref{tab:badtechpairs})
