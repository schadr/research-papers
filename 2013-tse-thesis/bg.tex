...
\subsubsection{Communication, Coordination and Integration}
...
\subsubsection{Can communication predict build failure?}
...
\subsubsection{The Need for Coordination}
...
\subsubsection{Coordination in Software Teams}
...
\subsubsection{Socio-Technical Congruence Definitions}
...
\paragraph{Task Assignment and Dependecy}
...
\paragraph{Social and Technical Networks}
...
\subsubsection{Socio-Technical Congruence and Performance}
...
\subsection{Networks and Failure}
...
\subsubsection{Artifact Networks}
\label{chap:6:an}
...
\begin{itemize}
  ...
  \item\textbf{RQ 2.3:} Can recommendations actually prevent build failures? (Chapter~\ref{chap:actionable})
\end{itemize}
