...
\section{Methodology and Constructs}
\label{chap:meth}
...
\subsubsection{Research Question 2.3}
\begin{itemize}
...
\begin{itemize}
\item\textbf{Project Members} are people who work on the software project. 
...
\item\textbf{Work Items} are units of work (as defined earlier) within the project that may create a need to collaborate and communicate. 
...
\item\textbf{Change-Sets} are changes made to software artifacts by individual users. 
...
\item\textbf{Software Artifact Relation} describe the relation between developers in the technical networks.
