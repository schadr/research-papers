...
%\end{enumerate}
%
%For example, the technical pair (Adam, Bart) appears in 3 successful builds and in
...
%We found that, the failure-related technical pairs span 48 out of the total 99 failed builds in
%the project. 
%%Figure~\ref{fig:builddistribution} shows their distribution
