...
Thus each change that is potentially interfering with the work of a developer is of interest to that developers.
...
This means when a developers sees a relevant change from another developer she contacts the other developer if the knowledge of that developer is perceived to not have sufficient knowledge in the area the change was applied to.
